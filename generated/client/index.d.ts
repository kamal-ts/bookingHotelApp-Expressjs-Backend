...
export namespace Prisma {
  ...
  */
  ...
  type GetDinosaurGroupByPayload<T extends DinosaurGroupByArgs> = PrismaPromise<
    Array<
  ...
  export interface DinosaurDelegate<GlobalRejectSettings extends Prisma.RejectOnNotFound | Prisma.RejectPerOperation | false | undefined> {
    ...
    **/
    ...
    ): PrismaPromise<Array<DinosaurGetPayload<T>>>
    ...
    **/
     ...
     * })
    **/
    aggregate<T extends DinosaurAggregateArgs>(args: Subset<T, DinosaurAggregateArgs>): PrismaPromise<GetDinosaurAggregateType<T>>
    ...
    **/
    ...
    >(args: SubsetIntersection<T, DinosaurGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetDinosaurGroupByPayload<T> : PrismaPromise<InputErrors>
   ...
   */
  export class Prisma__DinosaurClient<T, Null = never> implements PrismaPromise<T> {
    [prisma]: true;
